 ...
 *    ------------------------------------
 *    PINCS: any available pin  -->  CS
 *    PINMOSI: pin 11           -->  SDI (mandatory for hardware spi)
 *    PINMISO: pin 12           -->  SDO (mandatory for hardware spi)
 *    PINSCK: pin 13            -->  SCLK (mandatory for hardware spi)
 *
 *
...
public:
  ...
  MAX31865_RTD( ptd_type type,PinName pinmosi, PinName pinmiso, PinName pinsclk, PinName pinnss);
